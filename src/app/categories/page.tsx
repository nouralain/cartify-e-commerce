    ...
    <div className="max-w-[1500px] mx-auto p-4 md:p-8 bg-white my-4 shadow-sm">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-6 gap-6">
        {categories.data.map((cat) => (
           <Link key={cat._id} href="/products" className="bg-white rounded-lg p-2 flex flex-col items-center hover:shadow-lg hover:-translate-y-1 transition-all duration-200 group cursor-pointer border border-transparent hover:border-gray-200">
