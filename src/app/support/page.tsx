        ...
        <div className="w-full md:w-1/3 bg-[#f3f3f3] md:border-l border-gray-200 p-6 md:p-10 flex flex-col text-sm border-t md:border-t-0">
          ...
          <div className="space-y-6  grow">
            <div>
              ...
              <p className="text-muted-foreground mt-1 leading-snug">Available 24/7 constantly rotating support to aid you anywhere anytime.</p>
            </div>
            
            <div>
              <h3 className="font-bold text-[#0f1111]">Call Us Directly</h3>
              <p className="text-amazon-blue mt-1 hover:underline cursor-pointer hover:text-[#c45500]">1-800-123-4567</p>
            </div>

             <div>
              <h3 className="font-bold text-[#0f1111]">Mailing Address</h3>
              <p className="text-muted-foreground mt-1 leading-snug">410 Terry Ave. North<br/>Seattle, WA 98109-5210</p>
            </div>
          </div>
        </div>
