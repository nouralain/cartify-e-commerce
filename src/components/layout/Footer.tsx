      ...
      <div className="max-w-6xl mx-auto py-10 px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link href="#" className="hover:underline">About AmazonClone</Link></li>
            <li><Link href="#" className="hover:underline">Investor Relations</Link></li>
            <li><Link href="#" className="hover:underline">AmazonClone Devices</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-bold mb-4 text-sm md:text-base">Make Money with Us</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="#" className="hover:underline">Sell products on AmazonClone</Link></li>
            <li><Link href="#" className="hover:underline">Sell on AmazonClone Business</Link></li>
            <li><Link href="#" className="hover:underline">Sell apps on AmazonClone</Link></li>
        ...
        <div>
          <h3 className="font-bold mb-4 text-sm md:text-base">AmazonClone Payment Products</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="#" className="hover:underline">AmazonClone Business Card</Link></li>
            ...
            <li><Link href="#" className="hover:underline">AmazonClone Currency Converter</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-bold mb-4 text-sm md:text-base">Let Us Help You</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="/support" className="hover:underline">AmazonClone and COVID-19</Link></li>
